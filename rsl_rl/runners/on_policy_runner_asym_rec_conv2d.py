...
from rsl_rl.modules import (
    # ActorCriticConv2d,
    AsymActorCriticRecurrentConv2d,
    # AsymActorCriticRecurrentConv2d,
...
class OnPolicyRunnerAsymRecurrentConv2d(OnPolicyRunner):
    ...
    def __init__(self, env: VecEnv, train_cfg, log_dir=None, device="cpu"):
        ...
        actor_critic: AsymActorCriticRecurrentConv2d = AsymActorCriticRecurrentConv2d(
            num_prio_obs,
            num_critic_obs,
