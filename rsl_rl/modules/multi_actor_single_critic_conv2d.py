    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.actor = ConvolutionalNetwork(
            catch_actor_obs_dim=num_catch_actor_obs,
        ...
        self.catch_actor = MyMlp(
            input_dim=history_length * num_catch_actor_obs,
            output_dim=num_actions,
            hidden_dims=actor_hidden_dims,
            activation_fn=self.activation_fn,
        )
...
class ConvolutionalNetwork(nn.Module):
    def __init__(
        ...
        self.catch_actor_obs_size =  self.history_length * catch_actor_obs_dim
    ...
    def forward(self, observations):  # observations (batch_size, 4 + 230400 = 640*480)
        proprio_obs = observations[
            :,  self.catch_actor_obs_size: -self.image_obs_size
        ]  # proprio_obs (batch_size, history_length, 4) # proprio_obs_size
